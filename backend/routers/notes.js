...
const {addNote, editNote, getAllNotes, deleteNote, updateIsPinned, searchNotes} = require('../controllers/notes')
...
routerNote.get('/search-notes/', authentificateToken, searchNotes)
